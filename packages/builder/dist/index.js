...
function DraggableField({ field }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-sm font-medium text-slate-700", children: field.label }),
        field.isLayout && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-[10px] bg-indigo-100 text-indigo-700 font-semibold px-1.5 py-0.5 rounded-sm", children: "\u5BB9\u5668" })
      ]
    }
  );
}
function Sidebar() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "w-64 border-r border-slate-200 bg-slate-50 p-4 overflow-y-auto flex flex-col gap-6", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "text-xs font-bold text-slate-400 tracking-wider uppercase mb-3", children: "\u5E03\u5C40\u5BB9\u5668" }),
      layoutTemplates.map((field) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DraggableField, { field }, field.type))
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "text-xs font-bold text-slate-400 tracking-wider uppercase mb-3", children: "\u8868\u5355\u5B57\u6BB5" }),
...
function PropertyPanel() {
  ...
  const selectedElement = (0, import_react2.useMemo)(() => {
  ...
  if (!selectedElement) {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "w-80 border-l border-slate-200 bg-slate-50 p-4 text-slate-400 text-sm text-center pt-20 flex-shrink-0", children: "\u8BF7\u5148\u5728\u753B\u5E03\u4E2D\u9009\u4E2D\u4E00\u4E2A\u7EC4\u4EF6\u914D\u7F6E\u5C5E\u6027" });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "w-80 border-l border-slate-200 bg-white flex flex-col h-full flex-shrink-0", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "p-4 border-b border-slate-100 flex items-center justify-between", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "text-[10px] text-slate-400 font-mono", children: [
          "\u7C7B\u578B: ",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex-1 overflow-y-auto flex flex-col justify-between", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "p-4", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      ...
      (selectedElement.nodeType === "group" || selectedElement.nodeType === "grid" || selectedElement.nodeType === "list") && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "border-t border-slate-100 bg-slate-50/50 p-4 pb-6", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "flex items-center justify-between mb-3", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("h3", { className: "font-semibold text-xs text-slate-800 tracking-wide uppercase", children: [
          "\u5B50\u5B57\u6BB5\u7BA1\u7406 (",
          selectedElement.elements?.length || 0,
          ")"
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "space-y-2 mb-4 max-h-40 overflow-y-auto pr-1", children: [
          (selectedElement.elements || []).map((child, idx) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-col", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "font-medium text-slate-700", children: child.label || child.name }),
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "text-[10px] text-slate-400 font-mono", children: [
                    child.type,
                    " | ",
                    child.name
          ...
          (selectedElement.elements || []).length === 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "text-[11px] text-slate-400 text-center py-4 bg-white border border-dashed border-slate-200 rounded", children: "\u5F53\u524D\u5BB9\u5668\u6682\u65E0\u5B50\u5B57\u6BB5\uFF0C\u8BF7\u70B9\u51FB\u4E0B\u65B9\u6309\u94AE\u6DFB\u52A0" })
        ] }),
...
function FormBuilder() {
  ...
  const [isPreviewOpen, setIsPreviewOpen] = (0, import_react3.useState)(false);
  const [isExportOpen, setIsExportOpen] = (0, import_react3.useState)(false);
  const [copySuccess, setCopySuccess] = (0, import_react3.useState)(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_core3.DndContext, { collisionDetection: import_core3.closestCenter, onDragStart: handleDragStart, onDragEnd: handleDragEnd, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex flex-col h-screen w-screen bg-slate-50 text-slate-900 overflow-hidden font-sans", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("header", { className: "h-16 border-b border-slate-200 bg-white flex items-center justify-between px-6 z-20 shadow-sm shrink-0", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "w-10 h-10 rounded-xl bg-gradient-to-tr from-blue-600 to-indigo-600 flex items-center justify-center text-white shadow-md shadow-blue-500/20", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_lucide_react.Laptop, { className: "w-5 h-5" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "font-bold text-base tracking-tight bg-gradient-to-r from-slate-900 to-slate-800 bg-clip-text text-transparent", children: "pdyform Designer" }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "text-[10px] bg-blue-50 text-blue-600 font-semibold px-2 py-0.5 rounded-full border border-blue-100 flex items-center gap-1", children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_lucide_react.Sparkles, { className: "w-2.5 h-2.5" }),
              " Industrial Grade"
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "text-[10px] text-slate-400", children: "\u914D\u7F6E\u5F0F\u3001\u5B89\u5168\u6C99\u7BB1\u8868\u8FBE\u5F0F\u8BC4\u4F30\u3001\u6DF1\u5C42\u52A8\u6001\u8868\u683C monorepo \u751F\u6210\u5668" })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_lucide_react.FileJson, { className: "w-3.5 h-3.5 text-slate-500" }),
              "\u67E5\u770B Schema"
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_lucide_react.Code2, { className: "w-3.5 h-3.5" }),
              "\u5BFC\u51FA\u914D\u7F6E\u4EE3\u7801"
            ]
          }
        )
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_core3.DragOverlay, { children: [
      activeData && "isTemplate" in activeData ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "p-3 bg-white border-2 border-blue-500 rounded-lg shadow-lg flex items-center justify-between opacity-95 cursor-grabbing w-56", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "text-sm font-medium text-slate-700", children: activeData.label }),
        activeData.isLayout && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "text-[9px] bg-indigo-100 text-indigo-700 font-bold px-1.5 py-0.5 rounded", children: "\u5BB9\u5668" })
      ] }) : null,
      activeData && "isElement" in activeData ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "p-4 bg-white border-2 border-blue-500 rounded-lg shadow-lg opacity-95 cursor-grabbing w-[500px]", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "pointer-events-none", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_pdyform_react3.DynamicForm, { schema: { elements: [activeData.element] }, onSubmit: () => {
      }, hideSubmitButton: true }) }) }) : null
    ] }),
    (isPreviewOpen || isExportOpen) && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "fixed inset-0 z-50 flex justify-end bg-slate-900/30 backdrop-blur-[2px] transition-all duration-300", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "w-[580px] h-full bg-white shadow-2xl flex flex-col animate-slide-in relative border-l border-slate-100", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "p-6 border-b border-slate-100 flex items-center justify-between bg-white shrink-0", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("h3", { className: "font-bold text-base text-slate-800 flex items-center gap-2", children: [
            isPreviewOpen ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_lucide_react.FileJson, { className: "w-5 h-5 text-blue-500" }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_lucide_react.Code2, { className: "w-5 h-5 text-indigo-500" }),
            isPreviewOpen ? "Form Schema (JSON)" : "\u5BFC\u51FA\u8868\u5355\u914D\u7F6E\u4EE3\u7801"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "text-xs text-slate-400 mt-1", children: isPreviewOpen ? "\u76F4\u63A5\u5C06\u6B64\u914D\u7F6E\u5BF9\u8C61\u4F20\u7ED9 DynamicForm \u7684 schema \u5C5E\u6027\u5373\u53EF\u76F4\u63A5\u6E32\u67D3\u3002" : "\u914D\u7F6E\u652F\u6301 Rule AST \u8868\u8FBE\u5F0F\uFF0C\u65E0 eval/new Function \u6267\u884C\u98CE\u9669\u3002" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          "button",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_lucide_react.X, { className: "w-4 h-4" })
          }
        )
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "flex-1 overflow-auto p-6 bg-slate-950 font-mono text-xs text-slate-300 relative select-all leading-relaxed custom-scrollbar", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("pre", { className: "overflow-x-auto whitespace-pre-wrap break-all select-all selection:bg-blue-600/30", children: JSON.stringify(schema, null, 2) }) }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "p-4 border-t border-slate-100 flex justify-end gap-3 bg-slate-50 shrink-0", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          "button",
          {
            onClick: () => {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          "button",
          {
            ...
            children: copySuccess ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_lucide_react.Check, { className: "w-3.5 h-3.5" }),
              "\u5DF2\u6210\u529F\u590D\u5236!"
            ] }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_lucide_react.Copy, { className: "w-3.5 h-3.5" }),
              "\u590D\u5236 Schema"
            ] })
          }
        )
