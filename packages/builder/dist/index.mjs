...
function DraggableField({ field }) {
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx("span", { className: "text-sm font-medium", children: field.label })
    }
  );
}
function Sidebar() {
  return /* @__PURE__ */ jsxs("div", { className: "w-64 border-r border-slate-200 bg-slate-50 p-4 overflow-y-auto", children: [
    /* @__PURE__ */ jsx("h2", { className: "font-semibold mb-4 text-slate-800", children: "\u57FA\u7840\u7EC4\u4EF6" }),
...
function PropertyPanel() {
  ...
  return /* @__PURE__ */ jsxs3("div", { className: "w-80 border-l border-slate-200 bg-white flex flex-col h-full", children: [
    ...
    /* @__PURE__ */ jsx3("div", { className: "p-4 flex-1 overflow-y-auto", children: /* @__PURE__ */ jsx3(
      DynamicForm2,
      {
        form,
